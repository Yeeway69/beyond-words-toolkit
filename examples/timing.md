...
Companion starts relative to arrival: -4 seconds
...
Without an earlier view, the player has no reference for recognising what changed. The companion is also available for 3 of 10 seconds.
...
Combination available: 30
The supplied intervals overlap for 3 of the 10-second scene window. This replaces the qualitative availability check; it is not a second penalty.

Earlier visit encountered: 30
