...
Scene:
> A room with an uncertain earlier visit

Reading or intention (supplied, not inferred):
> A changed place may be recognized.

Source / provenance:
> Author-constructed demonstration with deliberately missing information.
...
A scene fact still needs checking.

Check whether the player encounters an earlier view of this place.

Reference for the change: 0–100
Whether the earlier reference is available is unresolved; no midpoint is invented.

Described encounter: 0–100

## Unresolved facts

Check whether the earlier reference is available on this encounter.
